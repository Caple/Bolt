...
public class Core {
	...
	private final static String serverPath = new File(Core.class.getProtectionDomain().getCodeSource().getLocation().getPath()).toString();
	private final static ProtocolRegistry protocol = new ProtocolRegistry(Core.class.getClassLoader());
	...
	public static ProtocolRegistry getProtocolCore() {
		return protocol;
	}
